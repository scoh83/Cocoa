...
//            ,"text/html; charset=utf-8", "utf-8")
        ...
        consonant.add(Consonant(R.drawable.rounded_corner1, "ㄱ", Color.parseColor("#6200EE"), "1", 1, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner2, "ㄴ", Color.parseColor("#FE9A2E"), "2", 2, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner3, "ㄷ", Color.parseColor("#FFBD12"), "3", 3, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner4, "ㄹ", Color.parseColor("#03DAC5"), "4", 1, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner5, "ㅁ", Color.parseColor("#FF89BB"), "5", 2, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner2, "ㅂ", Color.parseColor("#6200EE"), "6", 3, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner3, "ㅅ", Color.parseColor("#FFBD12"), "7", 1, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner4, "ㅇ", Color.parseColor("#03DAC5"), "8", 2, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner5, "ㅈ", Color.parseColor("#6200EE"), "9", 3, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner1, "ㅊ", Color.parseColor("#FF89BB"), "10", 1, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner3, "ㅋ", Color.parseColor("#FFBD12"), "11", 2, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner4, "ㅌ", Color.parseColor("#03DAC5"), "12", 3, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner5, "ㅍ", Color.parseColor("#FE9A2E"), "13", 1, View.VISIBLE))
        consonant.add(Consonant(R.drawable.rounded_corner1, "ㅎ", Color.parseColor("#FF89BB"), "14", 2, View.VISIBLE))
